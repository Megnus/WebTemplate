<?php 
/**
 * This is a masun pagecontroller.
 *
 */
// Include the essential config-file which also creates the $masun variable with its defaults.
...
// Do it and store it all in variables in the masun container.
$masun['title'] = "Kasta tärning";

$masun['main'] = <<<EOD
<h1>Kasta tärning</h1>
<p>Detta är en exempelsida som visar hur masun fungerar tillsammans med återanvändbara moduler.</p>
